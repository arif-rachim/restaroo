...
import {StoreValue, useStoreValue} from "../components/store/useStore";
import {Product, ProductConfigOption} from "./Product";
import {AppState} from "../components/AppState";
import invariant from "tiny-invariant";
import {ProductDetail} from "../components/page-components/AddToCartButton";
...
export function useShoppingCart() {
    ...
    async function addProductToCart(product:Product){
        ...
        store.setState(produce((s: AppState) => {
    ...
    return {addProductToCart, getTotalItemsInCart,addItemToCartByProductAndOptions,removeItemFromCartByProductAndOptions}
}
