...
export function CountryPicker(props: { value?: Country, onChange?: (value: Country) => void }) {

    const value = props.value ?? countryList.find(c => c.code === 'AE');
    ...
    return <div style={{
        ...
        <div style={{display: 'flex', flexDirection: 'column', padding: 5}}>
            <Button title={'OK'} onTap={() => {
                invariant(store.stateRef.current);
                onChange(store.stateRef.current)
            }} icon={IoCalendar}
